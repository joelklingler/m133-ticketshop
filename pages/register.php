...
if(isset($_SESSION['Role']))
{
	...
	<p>Sie werden in 5 Sekunden automatisch auf die Startseite weitergeleitet, oder drücken Sie <a href="?seite=home.php" alt="Zum Start">hier</a>.
	<script>
		setTimeout(function() {
	...
	<form class="col s6 register-form" action="" method="post">
		...
		<div class="row">
			...
			<div class="submit field col s6">
            	<button class="btn waves-effect waves-light" type="submit" value="Submit" name="action" id="register-submit">Registrieren
