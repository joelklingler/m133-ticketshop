...
else
{
	...
	// Gets the user and displays his data.
...
<form id="edit-profile-form">
	<div class="row">
		<div class="col s12">
			...
			<button class="btn waves-effect waves-light green" type="submit" value="Send" <?php echo "profile-id='".$_SESSION['User']."'"; ?> id="save-profile-detail">Änderungen Speichern
