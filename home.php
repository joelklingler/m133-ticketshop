        ...
        <form action="" method='post' class="col s12">
          ...
          <div class="row">
            <div class="submit-container">
              <button class="btn waves-effect waves-light" type="submit" value="Submit" name="action" id="login-submit">Einloggen
          ...
          <div class="row">
            <div class="register-link col s12">
              <a href="?seite=register.php">Noch kein Account? - Registrieren</a>
            </div>
          </div>
        </form>
      </div>
