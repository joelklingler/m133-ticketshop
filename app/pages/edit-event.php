...
if($role == 1)
{
	...
	$eventByUsers = getEventsByUser($_SESSION['User']);
	$eventIsUser = false;
	foreach ($eventByUsers as $event) 
	{
		if($event["Id"] == $_POST["event-id"])
		{
			$eventIsUser = true;
		}
	}
...
<?php
	...
	{
		?>
		<h5>Das ist nicht Ihre Veranstaltung.</h5>
		<?php
	}
}
else
